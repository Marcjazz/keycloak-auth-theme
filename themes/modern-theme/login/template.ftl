...
<#macro mainLayout title="" header="" bodyClass="" scripts=[]>
    ...
    <#assign bodyClasses = bodyClass!"flex items-center justify-center min-h-screen bg-gray-50 dark:bg-gray-900 p-4">
    <body class="${bodyClasses}">
        ...
        <#-- Global JS for login theme, if any, would be linked here or in head.
             Currently, main.js is built but not explicitly linked by default in this template.
             If needed: <script src="${url.resourcesPath}/js/main.js" defer></script>
        -->
    </body>
    </html>
</#macro>
